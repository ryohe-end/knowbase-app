...
function StoreSettingsSubMenu({ clubCode }: { clubCode: string }) {
  ...
  const menuItems = [
    ...
    ...(isJoyfit
      ? [
          {
            title: "OneTimePass 金額設定",
            desc: "JOYFIT の時間別(30〜210分)通常価格・予約価格を設定します。",
            href: `/store-settings/joyfit-onetimepass`,
            color: "#7c3aed",
            iconPath: "M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z",
          },
          {
            title: "OneTimePass 利用状況・消し込み",
            desc: "EnjoyTimePass の購入分析、チケットの消し込み(利用済/取消)を行います。",
            href: `/store-settings/basic/onetime-pass?clubCode=${clubCode}&view=dashboard`,
            color: "#f59e0b",
      ...
      : [
          {
            title: "1dayパス 金額設定",
            desc: "FIT365 の1dayパス通常価格・キャンペーン価格を設定します。",
    ...
    {
      title: "APP未納金支払い実績",
      desc: "アプリで支払われた未納金の実績（サマリー・明細）を確認します。",
